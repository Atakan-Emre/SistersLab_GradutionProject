...
public final class BackToolbarBinding implements ViewBinding {
  ...
  private BackToolbarBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatImageView backToolBar) {
  ...
  public static BackToolbarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.backToolBar;
      AppCompatImageView backToolBar = ViewBindings.findChildViewById(rootView, id);
      if (backToolBar == null) {
        break missingId;
      }

      return new BackToolbarBinding((ConstraintLayout) rootView, backToolBar);
    }
