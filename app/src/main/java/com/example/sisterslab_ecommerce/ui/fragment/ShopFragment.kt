...
import com.example.sisterslab_ecommerce.ui.adapter.ShopProductAdapter
...
import com.example.sisterslab_ecommerce.ui.viewmodel.ShopFragmentViewModel
...
class ShopFragment : Fragment(R.layout.fragment_shop) {
    ...
    private val viewModel: ShopFragmentViewModel by lazy { ViewModelProvider(this).get(
        ShopFragmentViewModel::class.java) }
